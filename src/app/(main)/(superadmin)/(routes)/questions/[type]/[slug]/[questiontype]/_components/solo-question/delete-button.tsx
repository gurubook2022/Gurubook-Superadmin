...
import { DELETE_SOLO_QUESTION } from "@/graphql/mutations";
...
const DeleteButton = ({ _id }: DeleteButtonProps) => {
  ...
  // Delete Mutation
  const [deleteSoloLanguage, { loading: deleteLoading }] =
    useMutation(DELETE_SOLO_QUESTION);

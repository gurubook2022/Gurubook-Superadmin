...
import { DELETE_BKF_SOLO_QUESTION } from "@/graphql/mutations";
...
const DeleteButton = ({ _id }: DeleteButtonProps) => {
  ...
  // Delete Mutation
  const [deleteBkfSoloQuestion, { loading: deleteLoading }] = useMutation(
    DELETE_BKF_SOLO_QUESTION
  );
